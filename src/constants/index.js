...
export const PAINT_BY_TYPE = {
  ...
  'fill-color': {
    ...
    stops: [
      ...
      ['Ecole privée', '#5499C7'],
      [`Jardin d'enfants`, '#5499C7 '],
      ['Autre héberg. collectif', '#5499C7'],
      ['Conservatoire musique', '#5499C7'],
      ['Foyer', '#5499C7'],
      ['Internat', '#5499C7'],
      ['Autre prod. agricole', '#138D75'],
      ['Ecurie', '#138D75'],
      ['Ferme', '#138D75'],
      ['Hangar agricole', '#138D75'],
      ['Porcherie', '#138D75'],
      ['Poulailler', '#138D75'],
      ['Serre', '#138D75'],
      ['Autre bât. de loisirs', '#D4E6F1'],
      ['Cinéma', '#D4E6F1'],
      [`Halle d'exposition`, '#D4E6F1'],
      ['Manège', '#D4E6F1'],
      ['Musée', '#D4E6F1'],
      ['Salle de spectacle', '#D4E6F1'],
      ['Salle de sport', '#D4E6F1'],
      ['Stade', '#D4E6F1'],
      ['Stand de tir', '#D4E6F1'],
      ['Théâtre', '#D4E6F1'],
      ['Centre de loisirs', '#D4E6F1'],
      ['Centre sportif', '#D4E6F1'],
      ['Consulat', '#5D6D7E'],
      ['Mission permanente', '#5D6D7E'],
      ['Autre bât. < 20 m2', '#FAE5D3'],
      ['Autre bât. 20 m2 et plus', '#FAE5D3'],
      [`Autre bât. d'activités`, '#FAE5D3'],
      ['Autre équip. collectif', '#FAE5D3'],
      ['Central de télécom.', '#FAE5D3'],
      ['Chantier naval', '#FAE5D3'],
      ['Installation téléphonie mobile', '#FAE5D3'],
      ['Poste', '#FAE5D3'],
    ],
  },
  'fill-opacity': 0.8,
